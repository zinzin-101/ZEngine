...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        //if (!diffusePBR.empty()) std::cout << "has PBR diffuse" << std::endl;
        ...
        //if (!normalPBR.empty()) std::cout << "has PBR normal" << std::endl;
        ...
        //if (!metallicPBR.empty()) std::cout << "has PBR metallic" << std::endl;
