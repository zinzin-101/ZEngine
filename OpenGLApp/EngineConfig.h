...
namespace EngineConfig {
	...
	constexpr SceneManagerConfig::SceneId INITIAL_SCENE_ID = SceneManagerConfig::TERRAIN_SCENE;
	constexpr float FIXED_DT = 1.0f / 144.0f;
	constexpr RendererOperation::RenderPipelines INITIAL_RENDERING_PIPELINE = RendererOperation::RenderPipelines::SIMPLE;
}